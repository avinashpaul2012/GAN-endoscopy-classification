# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 21:35:37 2020
...
def defineDiscriminator(input_dim=(128,256,1), n_classes=2):
...
def saveModel(c_model):
    c_model.save_weights("Classifier_fold1_labeled_sam500_BW2.h5") 
    
    
#################  Function for Train Model ###############################
    
    
def train(g_model, d_model, c_model, gan_model, latent_dim, n_epochs=2, batch_size=64):
